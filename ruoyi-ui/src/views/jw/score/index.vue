<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="分数状态" align="center" prop="status">
...
export default {
  ...
  methods: {
    ...
    getNormalCourse() {
      ...
      getNormalCourse(course).then((response) => {
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm('是否确认删除成绩管理编号为"' + ids + '"的数据项？')
        .then(function () {
          return delScore(ids);
        })
        .then(() => {
