...
public class ScoreController extends BaseController {
    ...
    @GetMapping("/count")
    public int count(){
        return scoreService.count();
    }
    /**
     * 查询成绩管理列表
     */
    @PreAuthorize("@ss.hasPermi('jw:score:list')")
    @GetMapping("/list")
     ...
     * 导出成绩管理列表
     */
    @PreAuthorize("@ss.hasPermi('jw:score:export')")
     ...
     * 获取成绩管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('jw:score:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增成绩管理
     */
    @PreAuthorize("@ss.hasPermi('jw:score:add')")
     ...
     * 修改成绩管理
     */
    @PreAuthorize("@ss.hasPermi('jw:score:edit')")
     ...
     * 删除成绩管理
     */
    @PreAuthorize("@ss.hasPermi('jw:score:remove')")
